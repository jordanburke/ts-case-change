...
describe("Regular expressions", () => {
  it("converts to camelCase", () => {
    ...
    expect(toCamel("the_quick_brown_fox_jumps_over_the_lazy_dog")).toEqual("theQuickBrownFoxJumpsOverTheLazyDog")
  ...
  it("converts to PascalCase", () => {
    ...
    expect(toPascal("the_quick_brown_fox_jumps_over_the_lazy_dog")).toEqual("TheQuickBrownFoxJumpsOverTheLazyDog")
  ...
  it("converts to snake case", () => {
    ...
    expect(toSnake("theQuickBrownFoxJumpsOver")).toEqual("the_quick_brown_fox_jumps_over")
...
describe("Property name converter with prefix preservation", () => {
  ...
  const _typeTest: AssertEqual<ConvertedType, ReturnType<typeof objectToCamelPrefix<TestInterface>>> = true
})
